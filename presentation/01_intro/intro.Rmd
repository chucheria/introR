...
El tidyverse es un conjunto de paquetes desarrollados por RStudio diseñados para trabajar juntos de manera "natural".

El propio paquete `tidyverse` se puede instalar y tiene varios paquetes contenidos pero podemos trabajar con ellos por separado e instalar paquetes que no estén incluídos y funcionen de la misma manera.
